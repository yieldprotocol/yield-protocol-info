...
const AssetPairTable = ({ assets, data, loading }: { assets: IAssetMap; data: IAssetPairData[]; loading: boolean }) => (
  <div className="rounded-lg shadow-sm px-8 py-4 bg-green-100 dark:bg-green-300">
    {loading ? (
      ...
      <div>
        ...
        <div className="mt-4 text-md italic">Total debt values taken from Cauldron only</div>
      </div>
    )}
  </div>
);
