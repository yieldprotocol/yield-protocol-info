      ...
      <div>
        {chainId && (
          <button
            ...
            className="text-gray-900 hover:bg-green-500 bg-green-300 dark:hover:bg-green-700 flex-shrink-0 inline-flex items-center justify-center overflow-hidden font-medium truncate focus:outline-none focus-visible:ring focus-visible:ring-offset-2 focus-visible:ring-green-800 focus-visible:ring-offset-green-900 transition dark:text-white dark:hover:bg-green-700 text-md leading-5 rounded-md px-3 py-2"
          >
                  ...
                  <div className="relative p-6">
                    <div className="my-4 text-gray-900 text-lg leading-relaxed">
                      {[...Object.keys(NETWORK_LABEL)].map((id: any) => (
                        <button
                          key={id}
                          className="mx-2 my-2 w-full text-gray-900 hover:bg-green-500 bg-green-300 dark:hover:bg-green-700 flex-shrink-0 inline-flex items-center justify-center overflow-hidden font-medium truncate focus:outline-none focus-visible:ring focus-visible:ring-offset-2 focus-visible:ring-green-800 focus-visible:ring-offset-green-900 transition dark:text-white dark:hover:bg-green-700 text-md leading-5 rounded-md px-3 py-2"
